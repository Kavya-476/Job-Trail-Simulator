...
import { Clock, BarChart, CheckCircle, ArrowLeft, Play } from 'lucide-react';
                        ...
                        <div className="space-y-4 w-full">
                            ...
                            <div className="flex flex-wrap items-center gap-3 text-sm font-bold mt-4">
                                <span className="flex items-center bg-gray-100 dark:bg-navy px-4 py-2 rounded-xl text-slate-600 dark:text-slate-300 transition-colors">
                                    <Clock className="w-4 h-4 mr-2 text-primary dark:text-primary-light" /> {job.time}
                                </span>
                                <span className="flex items-center bg-gray-100 dark:bg-navy px-4 py-2 rounded-xl text-slate-600 dark:text-slate-300 transition-colors">
                                    <CheckCircle className="w-4 h-4 mr-2 text-indigo-500 dark:text-indigo-400" /> {job.tasks_count} Tasks
                                </span>
                            </div>
                        </div>
